...
I added semantic HTML elements such a header and footer element. 

I also added alt attributes for accessiblity and cleaned up a few more sections. 

Finally, I changed the website title from "website" to a descriptive title.  
